    ...
    frame_gray(_frame_gray), P(_P), pc(_pc), circ_distance(_circ_distance), radius(_radius)
{
  ...
  Velodyne::Velodyne thresholded_scan = visible_scan.threshold(0.25);
  
  pcl::io::savePCDFile("/home/stamatis/my_ws/scan.pcd", scan.getPointCloud());
  pcl::io::savePCDFile("/home/stamatis/my_ws/visible_cloud.pcd", visible_cloud);

  //pcl::io::savePCDFile("/home/stamatis/my_ws/visible_clo.pcd", visible_cloud);
  
  PointCloud<PointXYZ>::Ptr xyz_cloud_ptr(thresholded_scan.toPointsXYZ());

  pcl::io::savePCDFile("/home/stamatis/my_ws/visible_cloud3.pcd", thresholded_scan.getPointCloud());
...
bool Calibration3DMarker::detectCirclesInPointCloud(vector<Point3f> &centers, vector<float> &radiuses)
{
  ...
  *detection_cloud += this->plane;
  ...
  for (int iterations = 0; iterations < 2048; iterations++)
  {
    ...
    //pcl::io::savePCDFile("/home/stamatis/my_ws/detection_cloud.pcd", *detection_cloud);
